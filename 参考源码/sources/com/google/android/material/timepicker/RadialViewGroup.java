...
class RadialViewGroup extends ConstraintLayout {
    ...
    public RadialViewGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(C0535R.layout.material_radial_view_group, this);
        ViewCompat.setBackground(this, createBackground());
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0535R.styleable.RadialViewGroup, i, 0);
        this.radius = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0535R.styleable.RadialViewGroup_materialCircleRadius, 0);
    ...
    protected void updateLayoutParams() {
        ...
        for (int i3 = 0; i3 < childCount; i3++) {
            ...
            if (childAt.getId() != C0535R.id.circle_center && !shouldSkipView(childAt)) {
                constraintSet.constrainCircle(childAt.getId(), C0535R.id.circle_center, this.radius, f);
