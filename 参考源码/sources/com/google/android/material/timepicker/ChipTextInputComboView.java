...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(Context context, AttributeSet attributeSet, int i) {
        ...
        Chip chip = (Chip) layoutInflaterFrom.inflate(C0535R.layout.material_time_chip, (ViewGroup) this, false);
        this.chip = chip;
        TextInputLayout textInputLayout = (TextInputLayout) layoutInflaterFrom.inflate(C0535R.layout.material_time_input, (ViewGroup) this, false);
        ...
        this.label = (TextView) findViewById(C0535R.id.material_label);
