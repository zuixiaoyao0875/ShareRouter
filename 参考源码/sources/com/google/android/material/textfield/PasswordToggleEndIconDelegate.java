...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        this.textInputLayout.setEndIconDrawable(AppCompatResources.getDrawable(this.context, C0535R.drawable.design_password_eye));
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C0535R.string.password_toggle_content_description));
