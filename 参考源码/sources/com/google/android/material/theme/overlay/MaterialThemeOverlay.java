...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C0535R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C0535R.attr.materialThemeOverlay};
