...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C0535R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0535R.attr.toolbarStyle);
    }
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C0535R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C0535R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(C0535R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = typedArrayObtainStyledAttributes.getBoolean(C0535R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = typedArrayObtainStyledAttributes.getBoolean(C0535R.styleable.MaterialToolbar_subtitleCentered, false);
