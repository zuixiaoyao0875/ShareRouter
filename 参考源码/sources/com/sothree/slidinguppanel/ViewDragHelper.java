...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new Interpolator() { // from class: com.sothree.slidinguppanel.ViewDragHelper.1
    ...
    private final Runnable mSetIdleRunnable = new Runnable() { // from class: com.sothree.slidinguppanel.ViewDragHelper.2
    ...
    public static ViewDragHelper create(ViewGroup viewGroup, float f, Interpolator interpolator, Callback callback) {
        ViewDragHelper viewDragHelperCreate = create(viewGroup, interpolator, callback);
        viewDragHelperCreate.mTouchSlop = (int) (viewDragHelperCreate.mTouchSlop * (1.0f / f));
        return viewDragHelperCreate;
    }
    ...
    */
    public boolean shouldInterceptTouchEvent(android.view.MotionEvent r10) {
        /*
            Method dump skipped, instruction units count: 261
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.sothree.slidinguppanel.ViewDragHelper.shouldInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            ...
            while (i2 < pointerCount) {
                ...
                if (this.mDragState != 1) {
                    View viewFindTopChildUnder2 = findTopChildUnder((int) this.mInitialMotionX[pointerId2], (int) this.mInitialMotionY[pointerId2]);
