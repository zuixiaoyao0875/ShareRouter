...
public final class ResourceManagerInternal {
    ...
    public synchronized Drawable getDrawable(Context context, int i) throws XmlPullParserException, IOException {
        return getDrawable(context, i, false);
    }

    synchronized Drawable getDrawable(Context context, int i, boolean z) throws XmlPullParserException, IOException {
    ...
    private Drawable loadDrawableFromDelegates(Context context, int i) throws XmlPullParserException, IOException {
        int next;
