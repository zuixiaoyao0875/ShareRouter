        ...
        protected Insets getInsetsForType(int i, boolean z) {
            ...
            if (i == 2) {
                if (z) {
                    ...
                    return Insets.m4of(Math.max(rootStableInsets.left, stableInsets2.left), 0, Math.max(rootStableInsets.right, stableInsets2.right), Math.max(rootStableInsets.bottom, stableInsets2.bottom));
                }
                ...
                return Insets.m4of(systemWindowInsets.left, 0, systemWindowInsets.right, iMin);
            }
            if (i == 8) {
                ...
                if (systemWindowInsets2.bottom > rootStableInsets2.bottom) {
                    return Insets.m4of(0, 0, 0, systemWindowInsets2.bottom);
                }
            ...
            if (i == 128) {
                ...
                if (displayCutout != null) {
                    return Insets.m4of(displayCutout.getSafeInsetLeft(), displayCutout.getSafeInsetTop(), displayCutout.getSafeInsetRight(), displayCutout.getSafeInsetBottom());
                }
                return Insets.NONE;
            }
            return Insets.NONE;
                ...
                try {
                    ...
                    if (obj != null) {
                        ...
                        if (rect != null && rect2 != null) {
                            WindowInsetsCompat windowInsetsCompatBuild = new Builder().setStableInsets(Insets.m5of(rect)).setSystemWindowInsets(Insets.m5of(rect2)).build();
