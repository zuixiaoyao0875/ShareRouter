...
public abstract class FragmentTransaction {
    ...
    static final class C0320Op {
        ...
        C0320Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0320Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0320Op c0320Op) {
        this.mOps.add(c0320Op);
        c0320Op.mEnterAnim = this.mEnterAnim;
        c0320Op.mExitAnim = this.mExitAnim;
        c0320Op.mPopEnterAnim = this.mPopEnterAnim;
        c0320Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0320Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0320Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0320Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0320Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0320Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0320Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0320Op(10, fragment, state));
        return this;
    }
