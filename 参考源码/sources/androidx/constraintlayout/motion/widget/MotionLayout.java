...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    void setState(TransitionState transitionState) {
        ...
        int i = C01502.f27xabc7e4ac[transitionState2.ordinal()];
        if (i == 1 || i == 2) {
    ...
    class Model {
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            if (constraintWidget.mTop.mTarget != null) {
                str2 = "T" + (constraintWidget.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
            } else {
                str2 = "__";
            }
            StringBuilder sbAppend2 = new StringBuilder().append(sbAppend.append(str2).toString());
            if (constraintWidget.mBottom.mTarget != null) {
                str3 = "B" + (constraintWidget.mBottom.mTarget.mType == ConstraintAnchor.Type.TOP ? "T" : "B");
            } else {
                str3 = "__";
            }
            StringBuilder sbAppend3 = new StringBuilder().append(sbAppend2.append(str3).toString());
            if (constraintWidget.mLeft.mTarget != null) {
                str4 = "L" + (constraintWidget.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            } else {
                str4 = "__";
            }
            StringBuilder sbAppend4 = new StringBuilder().append(sbAppend3.append(str4).toString());
            if (constraintWidget.mRight.mTarget != null) {
                str5 = "R" + (constraintWidget.mRight.mTarget.mType == ConstraintAnchor.Type.LEFT ? "L" : "R");
            }
            Log.v(MotionLayout.TAG, str + sbAppend4.append(str5).toString() + " ---  " + constraintWidget);
        }
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String str4 = (((BuildConfig.FLAVOR + (constraintWidget.mTop.mTarget != null ? "T" : "_")) + (constraintWidget.mBottom.mTarget != null ? "B" : "_")) + (constraintWidget.mLeft.mTarget != null ? "L" : "_")) + (constraintWidget.mRight.mTarget != null ? "R" : "_");
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float f, float f2) {
            ...
            String str = BuildConfig.FLAVOR + (((int) ((fHypot2 * 100.0f) / fHypot)) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float f, float f2) {
            ...
            String str = BuildConfig.FLAVOR + (((int) (((double) ((fMin2 * 100.0f) / Math.abs(f5 - f3))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = BuildConfig.FLAVOR + (((int) (((double) ((fMax2 * 100.0f) / Math.abs(f6 - f4))) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float f, float f2, int i, int i2) {
            String str = BuildConfig.FLAVOR + (((int) (((double) (((f - (i / 2)) * 100.0f) / (MotionLayout.this.getWidth() - i))) + 0.5d)) / 100.0f);
            getTextBounds(str, this.mTextPaint);
            ...
            String str2 = BuildConfig.FLAVOR + (((int) (((double) (((f2 - (i2 / 2)) * 100.0f) / (MotionLayout.this.getHeight() - i2))) + 0.5d)) / 100.0f);
            getTextBounds(str2, this.mTextPaint);
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0173R.styleable.MotionLayout);
            int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
            boolean z = true;
            for (int i = 0; i < indexCount; i++) {
                int index = typedArrayObtainStyledAttributes.getIndex(i);
                if (index == C0173R.styleable.MotionLayout_layoutDescription) {
                    this.mScene = new MotionScene(getContext(), this, typedArrayObtainStyledAttributes.getResourceId(index, -1));
                } else if (index == C0173R.styleable.MotionLayout_currentState) {
                    this.mCurrentState = typedArrayObtainStyledAttributes.getResourceId(index, -1);
                } else if (index == C0173R.styleable.MotionLayout_motionProgress) {
                    this.mTransitionGoalPosition = typedArrayObtainStyledAttributes.getFloat(index, 0.0f);
                    this.mInTransition = true;
                } else if (index == C0173R.styleable.MotionLayout_applyMotionScene) {
                    z = typedArrayObtainStyledAttributes.getBoolean(index, z);
                } else if (index == C0173R.styleable.MotionLayout_showPaths) {
                    if (this.mDebugPath == 0) {
                        this.mDebugPath = typedArrayObtainStyledAttributes.getBoolean(index, false) ? 2 : 0;
                    }
                } else if (index == C0173R.styleable.MotionLayout_motionDebug) {
