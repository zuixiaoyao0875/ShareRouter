...
public class ConstraintWidget {
    ...
    public String toString() {
        ...
        StringBuilder sbAppend = sb.append(str != null ? "type: " + this.mType + " " : BuildConfig.FLAVOR);
        if (this.mDebugName != null) {
            str2 = "id: " + this.mDebugName + " ";
        }
        return sbAppend.append(str2).append("(").append(this.f35mX).append(", ").append(this.f36mY).append(") - (").append(this.mWidth).append(" x ").append(this.mHeight).append(")").toString();
    }
    ...
    public void setGoneMargin(ConstraintAnchor.Type type, int i) {
        int i2 = C01621.f37x4c44d048[type.ordinal()];
        if (i2 == 1) {
  ...
  0x0084: PHI (r0v2 int) = (r0v1 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int), (r0v0 int) binds: [B:45:0x0084, B:35:0x007d, B:23:0x004f, B:25:0x0055, B:27:0x0061, B:29:0x0065] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type type) {
        switch (C01621.f37x4c44d048[type.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:195:0x0322 A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:196:0x0323  */
    /* JADX WARN: Removed duplicated region for block: B:276:0x0404  */
    /* JADX WARN: Removed duplicated region for block: B:279:0x0412 A[ADDED_TO_REGION] */
