...
public class SolverVariable {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        int i = C01551.$SwitchMap$androidx$constraintlayout$solver$SolverVariable$Type[type.ordinal()];
        if (i == 1) {
    ...
    public String toString() {
        ...
        return BuildConfig.FLAVOR + this.f31id;
    }
}
