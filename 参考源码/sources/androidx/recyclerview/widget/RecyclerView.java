...
import androidx.recyclerview.C0398R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public RecyclerView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0398R.attr.recyclerViewStyle);
    }
    ...
    public RecyclerView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0398R.styleable.RecyclerView, i, 0);
        if (Build.VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0398R.styleable.RecyclerView, attributeSet, typedArrayObtainStyledAttributes, i, 0);
        }
        String string = typedArrayObtainStyledAttributes.getString(C0398R.styleable.RecyclerView_layoutManager);
        if (typedArrayObtainStyledAttributes.getInt(C0398R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
            setDescendantFocusability(262144);
        }
        this.mClipToPadding = typedArrayObtainStyledAttributes.getBoolean(C0398R.styleable.RecyclerView_android_clipToPadding, true);
        boolean z2 = typedArrayObtainStyledAttributes.getBoolean(C0398R.styleable.RecyclerView_fastScrollEnabled, false);
        this.mEnableFastScroller = z2;
        if (z2) {
            initFastScroller((StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0398R.styleable.RecyclerView_fastScrollVerticalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0398R.styleable.RecyclerView_fastScrollVerticalTrackDrawable), (StateListDrawable) typedArrayObtainStyledAttributes.getDrawable(C0398R.styleable.RecyclerView_fastScrollHorizontalThumbDrawable), typedArrayObtainStyledAttributes.getDrawable(C0398R.styleable.RecyclerView_fastScrollHorizontalTrackDrawable));
        }
    ...
    */
    ...
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:47:0x00e2 A[PHI: r0
  0x00e2: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00cb, B:45:0x00de] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final class Recycler {
        ...
        /* JADX WARN: Removed duplicated region for block: B:73:0x018e A[PHI: r1 r4
  0x018e: PHI (r1v19 androidx.recyclerview.widget.RecyclerView$ViewHolder) = 
  (r1v18 androidx.recyclerview.widget.RecyclerView$ViewHolder)
  (r1v45 androidx.recyclerview.widget.RecyclerView$ViewHolder)
 binds: [B:28:0x005d, B:59:0x0106] A[DONT_GENERATE, DONT_INLINE]
  0x018e: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:59:0x0106] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static abstract class LayoutManager {
        ...
        */
        ...
        public static Properties getProperties(Context context, AttributeSet attributeSet, int i, int i2) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0398R.styleable.RecyclerView, i, i2);
            properties.orientation = typedArrayObtainStyledAttributes.getInt(C0398R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = typedArrayObtainStyledAttributes.getInt(C0398R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = typedArrayObtainStyledAttributes.getBoolean(C0398R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = typedArrayObtainStyledAttributes.getBoolean(C0398R.styleable.RecyclerView_stackFromEnd, false);
            typedArrayObtainStyledAttributes.recycle();
            return properties;
        }
    ...
    void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        new FastScroller(this, stateListDrawable, drawable, stateListDrawable2, drawable2, resources.getDimensionPixelSize(C0398R.dimen.fastscroll_default_thickness), resources.getDimensionPixelSize(C0398R.dimen.fastscroll_minimum_range), resources.getDimensionPixelOffset(C0398R.dimen.fastscroll_margin));
    }
